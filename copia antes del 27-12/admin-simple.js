// admin-simple.js - Sistema de administración con precio fijo con $
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let precioConDolar = true; // Control para mantener el $
    ...
    // Función para escapar HTML (protege contra XSS)
...
`;
                ...
                html += `
                    <div class="producto-admin-item" 
                        ...
                        <div style="display: flex; gap: 8px;">
                            <button class="auth-btn" onclick="editarProducto('${producto.id}')" 
                                    style="padding: 8px 15px; font-size: 13px; background: linear-gradient(135deg, #2196F3, #1976D2); 
                                           color: white; border: none; border-radius: 6px; cursor: pointer;
                                           display: flex; align-items: center; gap: 5px;">
                                ✏️ Editar
                            </button>
                            <button class="auth-btn" onclick="eliminarProducto('${producto.id}')" 
    ...
    function guardarProducto(e) {
        ...
        if (productoId && productoEditando !== null) {
            ...
            agregarProductoDB(nuevoProducto);
    ...
    function resetFormProducto() {
        ...
        document.getElementById('adminImagen').placeholder = 'jabonAriel.jpg';
    }
    
    // ========== FUNCIONES DE PRODUCTOS ==========
    function obtenerProductos() {
        return window.ProductosDB ? window.ProductosDB.obtenerTodos() : productos;
    }
    ...
    if (!document.querySelector('style#animaciones-notificacion')) {
        ...
        style.textContent = `
            ...
            /* Indicador visual del $ fijo */
            .precio-dolar-fijo::before {
                content: "$";
                position: absolute;
                left: 12px;
                top: 50%;
